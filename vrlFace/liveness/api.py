...
接口:
    POST /vrlMoveLiveness  — 视频活体检测 + 动作验证
"""
...
async def vrl_move_liveness(req: MoveLivenessRequest) -> MoveLivenessResponse:
    ...
    logger.info(
        ...
        req.request_id, req.task_id, req.video_path, req.actions,
    )
    ...
    # 支持的动作白名单
    SUPPORTED_ACTIONS = {
        "blink", "mouth_open", "shake_head", "nod",
        "nod_down", "nod_up", "turn_left", "turn_right",
    }
    ...
    try:
        ...
        logger.info(
            ...
            req.request_id, result.is_liveness, result.liveness_confidence,
