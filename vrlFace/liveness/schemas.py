...
class ThresholdConfig(BaseModel):
    liveness_threshold: float = Field(default=0.5, ge=0.0, le=1.0, description="活体判定阈值")
    action_threshold: float = Field(default=0.85, ge=0.0, le=1.0, description="单动作通过阈值")
